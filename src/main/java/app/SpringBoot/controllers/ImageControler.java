...
public class ImageControler {
    ...
    public ResponseEntity<String> uploadImage(@RequestParam("imageFile")MultipartFile file, @PathVariable Long idUser) throws IOException {
        return imageServiceIInter.uploadImage(file,idUser);
    }
    ...
    {
        return imageServiceIInter.getImage(idUser);
...
@PutMapping("update/{idUser}")
    ...
    return imageServiceIInter.updateImage(file, idUser);
}
...
{
    return imageServiceIInter.deleteImage(idUser);
}
